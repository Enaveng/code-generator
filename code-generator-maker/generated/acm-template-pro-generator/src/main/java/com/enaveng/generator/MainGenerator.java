...
public class MainGenerator {
    ...
    public static void doGenerate(DataModel model) throws TemplateException, IOException {
        ...
        inputPath = new File(inputRootPath, "src/com/yupi/acm/MainTemplates.java.ftl").getAbsolutePath();
        outputPath = new File(outputRootPath, "src/com/enaveng/acm/MainTemplate.java").getAbsolutePath();
