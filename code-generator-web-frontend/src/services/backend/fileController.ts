...
/** testCreateBucket POST /api/file/test/create */
export async function testCreateBucketUsingPost(options?: { [key: string]: any }) {
  return request<any>('/api/file/test/create', {
    method: 'POST',
    ...(options || {}),
  });
}
